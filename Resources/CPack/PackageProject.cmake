...
elseif("${IMFViewerProj_RELEASE_TYPE}" STREQUAL "Beta")
  set(IMFViewer_VERSION_SHORT "${IMFViewerProj_VERSION_MAJOR}.${IMFViewerProj_VERSION_MINOR}-${IMFViewerProj_RELEASE_TYPE}-${IMFViewerProj_VERSION_TWEAK}")
elseif("${IMFViewerProj_RELEASE_TYPE}" STREQUAL "Development")
  set(IMFViewer_VERSION_SHORT "${IMFViewerProj_VERSION_MAJOR}.${IMFViewerProj_VERSION_MINOR}.${IMFViewerProj_VERSION_PATCH}.${IMFViewerProj_VERSION_TWEAK}")
else()
  set(IMFViewer_VERSION_SHORT "0.0.0")
endif()
...
SET(CPACK_PACKAGE_VERSION_MAJOR ${IMFViewer_VER_MAJOR})
SET(CPACK_PACKAGE_VERSION_MINOR ${IMFViewer_VER_MINOR})
SET(CPACK_PACKAGE_VERSION_PATCH ${IMFViewer_VER_PATCH})
SET(CPACK_PACKAGE_VERSION ${IMFViewer_VERSION})


set(CPACK_PACKAGE_EXECUTABLES
    IMFViewer IMFViewer StatsGenerator StatsGenerator DevHelper DevHelper)
set(UPLOAD_FILE_NAME "")

if(APPLE)
    set(CPACK_PACKAGE_FILE_NAME "IMFViewer-${IMFViewer_VERSION_SHORT}-OSX")
...
elseif(WIN32)
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "IMFViewer-${IMFViewer_VERSION_SHORT}-Win64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "IMFViewer-${IMFViewer_VERSION_SHORT}-Win32")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    else()
        set(CPACK_PACKAGE_FILE_NAME "IMFViewer-${IMFViewer_VERSION_SHORT}-Unknown")
        set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    endif()
else()
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "IMFViewer-${IMFViewer_VERSION_SHORT}-${IMFViewer_LINUX_SYSTEM}-x86_64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "IMFViewer-${IMFViewer_VERSION_SHORT}-${IMFViewer_LINUX_SYSTEM}-i386")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    else()
        set(CPACK_PACKAGE_FILE_NAME "IMFViewer-${IMFViewer_VERSION_SHORT}-${CMAKE_SYSTEM_NAME}")
        set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    endif()
endif()
...
SET(CPACK_SOURCE_PACKAGE_FILE_NAME "CSDF-${IMFViewer_VERSION_SHORT}-Source")
